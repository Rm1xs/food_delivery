...
class OrdersCubit extends Cubit<void> {
  ...
  Future<void> addToOrders(String food) async => _ordersRepository.repository.addToOrder(food);

  Future<DocumentSnapshot> getItemsInOrder() async => _ordersRepository.getItemsInOrder();
}